        ...
        <div className="flex justify-center w-full pt-8">
            ...
            <div className="max-w-screen-lg w-full">        
                ...
                <button onClick={ async () => {
                    ...
                    }} type="submit" className="mt-4 inline-flex items-center px-5 py-2 py-2.5 text-sm font-medium text-center text-white bg-blue-700 rounded-lg focus:ring-4 focus-ring-blue-200 dark:focus:ring-blue-900 hover:bg-blue-800">
                    Publish post
                </button>
            </div> 
        </div>
